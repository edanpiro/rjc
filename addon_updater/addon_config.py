...
class addon_config(models.Model):
    ...
    name = fields.Selection(selection='_get_addon_name', string='Addon Project', required=True)
    ...
    @api.multi
    def onchange_rootpath(self, rootpath):
        res = {}
        if not rootpath:
            return res
